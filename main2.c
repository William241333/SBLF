...
int main()
{
    ...
    if (strcmp(dataSource, "Simulation") == 0)
    {
        ...
        strcat(inpathx, "/Users/apple/Desktop/ImageOnImageRegression/SimulationStudy/Data/");
        strcat(inpath, "/Users/apple/Desktop/ImageOnImageRegression/SimulationStudy/Data/Linear/");
        strcat(outpath, "/Users/apple/Desktop/ImageOnImageRegression/SimulationStudy/Result/Linear/");
    }
    else if (strcmp(dataSource, "RealData") == 0)
    {
        printf("Data from a subset of the real data.\n");
        strcat(inpathx, "E:\\c++code\\Data\\");
        strcat(inpath, inpathx);
        strcat(outpath, "E:\\c++code\\Result\\");
    }
    else
    {
    ...
    // Length of chain
    int iter = 50000;   // total iterations
    int burnin = 25000; // iterations after burnin
